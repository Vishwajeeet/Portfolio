    ...
    <div className="mt-24 max-w-[1200px] mx-auto relative" id="hero">
      <div className="grid md:grid-cols-2 place-items-center gap-8">
        ...
        >
          ...
          >
            HEY, I AM <br />
            <span className="	text-sky-400">Vishwajeet Mishra</span>
          </motion.p>
          ...
          >
            ...
            >
              <a
                href="./Vishwajeet_Mishra.pdf"
                download="Vishwajeet_Mishra.pdf"
            ...
            <div className="flex gap-6 flex-row text-4xl md:text-sky-500 z-20">
              <motion.a
                ...
                href="https://github.com/Vishwajeeet"
              ...
              <motion.a
                target="_blank"
                whileHover={{ scale: 1.2 }}
                href="https://www.linkedin.com/in/vishwajeet-mishra-5a47b72b9/"
                className="  text-gray-300"
              >
                <AiOutlineLinkedin />
              </motion.a>
              ...
              <motion.a
                target="_blank"
                whileHover={{ scale: 1.2 }}
                href="mailto:vishwajeet.mishra207@gmail.com"
                className="  text-gray-300"
              >
                <AiOutlineMail />
              </motion.a>
